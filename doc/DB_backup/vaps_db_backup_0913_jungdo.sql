...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "VAPS"."ITEM_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 41 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Table BOARD
--------------------------------------------------------
...
SET DEFINE OFF;
Insert into VAPS.ITEMS (I_NUM,I_NAME,I_CATEGORY,I_PRICE,I_PIC) values (21,'비빔밥','도시락',2000,'bi1.jpg');
REM INSERTING into VAPS.ITEMSTORED
SET DEFINE OFF;
Insert into VAPS.ITEMSTORED (IS_NAME,IS_COUNT) values ('비빔밥',10111);
